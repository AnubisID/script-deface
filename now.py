#!/usr/bin/python
#######################
#  http://fb.com/percil al madadi  #
#######################
mess = """======================================================
    welcome to my script Deface Script Creator       
           jangan coli sembarangan yaa
             hacker by - Mr.p3rc1l
   thacks to : mimber WARIOR team - Mr.panjul - 
                Rizki Dermawan -
======================================================"""

print mess
print "              -------Created by Mr.p3rc1l-------"
...
kata2_sakit_hati = raw_input("tehnik nembak pacar(lu_kan_jomlo): ")
...
print "       -_-    Kontak : fb.com/percil al madadi    -_-"
print "          -_-         jangan coli yee!!        -_-"
